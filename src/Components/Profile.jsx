                ...
                <aside id="profile-detailes">
                    ...
                    <div id="details">
                            <section id="aside-container">
                                <img src="https://panorbit.in/wp-content/uploads/2019/hotlink-ok/1001.jpeg" alt="" />
                                <h1>Leanne Graham</h1>
                                <p>Username    : <strong>Bret</strong></p>
                                <p>e-mail  : <strong>Sincere@april.biz</strong></p>
                                <p>Phone  :  <strong>9999999999</strong></p>
                                <p>Website  :  <strong>leannegraham.com</strong></p>
                                <hr />
                                <h2>Company</h2>
                                <p>Name   :  <strong>Romaguera-Crona</strong></p>
                                <p>catchphrase   : <strong>Multi-layered client-server </strong> </p>
                                <p>bs  : <strong>harness real-time e-markets</strong></p>
                            </section>
                            <section className="side-container">
                                <h1>Address:</h1>
                                <p>Street  : <strong>Kulas Light</strong></p>
                                <p>Suit  :  <strong>Apt.556</strong></p>
                                <p>City  :  <strong>Gwenborough</strong></p>
                                <p>Zipcode  : <strong>92998-3874</strong></p>
